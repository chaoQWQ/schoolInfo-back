...
public class ShiroConfig {
     ...
     */
    @Bean
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager, SysPermissionService sysPermissionService) {
        ShiroFilterFactoryBean shiroFilterFactoryBean = new ShiroFilterFactoryBean();
        shiroFilterFactoryBean.setSecurityManager(securityManager);
        shiroFilterFactoryBean.setLoginUrl("/api/sys/notLogin");
...
//        shiroFilterFactoryBean.setUnauthorizedUrl("/");
        ...
        filterChainDefinitionMap.put("/api/static/**", "anon");
        filterChainDefinitionMap.put("/api/sys/**", "anon");
        filterChainDefinitionMap.put("/api/compinfo/getTitle", "anon");
...
//    }
    ...
    public RedisManager redisManager(){
        ...
        redisManager.setPassword("782779359");
        return redisManager;
    }
    ...
    public SessionDAO sessionDAO() {
        ...
        //session在redis中的保存时间(单位秒),最好大于session会话超时时间
