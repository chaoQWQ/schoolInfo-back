...
public enum WebApiResultCodeEnum
{
	...
	RESULT_NULL("000004", "RESULT_NULL", "搜索结果为空"),
	INVENTORY_SHORTAGE("000005", "INVENTORY_SHORTAGE", "报名人数已满"),
	OPERATION_NOT_ALLOWED("000006", "OPERATION_NOT_ALLOWED", "操作不允许"),
	AUTHCODE_ERROR("000007", "AUTHCODE_ERROR", "验证码错误"),
	NOT_BINDING("000008", "NOT_BINDING", "用户未绑定邮箱"),
